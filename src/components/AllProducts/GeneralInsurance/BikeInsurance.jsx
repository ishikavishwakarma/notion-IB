...
const TABLE_ROWS_PAGE_1 = [
  {
    point: "Coverage",
    comprehensive: "Own-Damage, Third-Party Liabilities,Theft, Fire, Natural,Calamities",
...
const BikeInsurance = () => {
  ...
  return (
   ...
   <div>
     ...
     <div>
     <ImageTextCard
     heading="What Is Bike Insurance?"
     ...
     <InsuranceTypes 
       ...
       description="
There are 3 types of bike insurance policy in India and Notion Insurance offers all of them."
