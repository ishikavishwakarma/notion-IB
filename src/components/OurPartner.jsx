...
const OurPartner = () => {
  const partners = [
    ...
    { name: "Max Life", logo: "assets/images/company/Max Life.jpg" },
    {
      ...
      logo: "assets/images/company/National insurance.jpg",
    },
    ...
    {
      name: "The New India",
      logo: "assets/images/company/The new india assurance co.ltd.jpg",
    },
